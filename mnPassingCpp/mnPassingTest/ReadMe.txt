...
========================================================================
    KONSOLENANWENDUNG: mnPassingTest-Projektübersicht
========================================================================

Diese mnPassingTest-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre mnPassingTest-Anwendung besteht.


mnPassingTest.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "mnPassingTest.pch und eine 
