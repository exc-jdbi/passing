...
========================================================================
    DYNAMIC LINK LIBRARY: mnPassing-Projektübersicht
========================================================================

Diese mnPassing-DLL wurde vom Anwendungs-Assistenten für 
Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre mnPassing-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "mnPassing.pch und eine 
